/**
 * Created by fearless on 05.10.14.
 */
var oscar = (function(o, $) {
    ...
    o.messages = {
        addMessage: function(tag, msg) {
            var msgHTML = '<div data-alert class="alert-box fade in ' + tag + '">' +
                '<a href="#" class="close">&times;</a>'  + msg +
                '</div>';
    ...
    o.forms = {
        init: function() {
            ...
            $('#add_to_basket_form #id_product_id').change(function(e) {
                    $.get($(this).val(), {}, function(data) {
                        $('.product_page .large-6 h2.price_color').text(data.price);
                    }, 'json');
                }
            );
        },
    ...
    o.responsive = {
        ...
        initNav: function() {
            ...
            var $sidebar = $('aside.large-3'),
                $browse = $('[data-navigation="dropdown"]'),
